            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Sandamini!`}<br/> <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Web Designer", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
                  ...
                  <a href="https://drive.google.com/file/d/1liWmJ0VbW4Whr1jQBMjM7u-em_7DPpCP/view?usp=drive_link" download="sandamini_nayanathara.pdf" style={{ textDecoration: 'none' }}>
  <button>
