...
return (
  ...
  <Col xs={12} md={6} lg={4} style={{ marginBottom: '20px', paddingLeft: '15px', paddingRight: '15px', paddingTop:'20px' }}>
    <BlogCard
      imagePath={yourImagePath1}
      title="Real-World Applications of Machine Learning"
      excerpt="Introduction Machine Learning (ML) has emerged as a transformative technology..."
